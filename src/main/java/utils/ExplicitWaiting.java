...
public class ExplicitWaiting extends BaseMethod
{
	...
	public static void explicitWaitElementToBeClickable(WebElement element, int time) throws Exception {
	...
	public static void explicitWaitElementToBeSelected(WebElement element, int time) throws Exception{
	...
	public static void explicitWaitTextToBePresentInElement(WebElement element, int time, String text) throws Exception{
	...
	public static void explicitWaitTitleContains(WebElement element, int time, String title) throws Exception{
	...
	public static void explicitWaitTitleIs(WebElement element, int time, String title) throws Exception{
	...
	public static void explicitWaitVisibilityOfElement(WebElement element, int time) throws Exception{
	...
	public static void explicitWaitVisibilityOfElements(List<WebElement> element, int time) throws Exception{
	...
	/** To Wait Until Element to be Clickable */	
	public static void explicitWaitElementToBeClickable(By element, int time) throws Exception{
		WebDriverWait clickableWait = new WebDriverWait(getWebDriver(), time);
		clickableWait.until(ExpectedConditions.elementToBeClickable(element));
	}
	...
	/** To Wait Until Element to be Selectable */
	public static void explicitWaitElementToBeSelected(By element, int time) throws Exception{
		WebDriverWait selectableWait = new WebDriverWait(getWebDriver(), time);
		selectableWait.until(ExpectedConditions.elementToBeSelected(element));
	}
	...
	/** To Wait Until Title contains the text */
	public static void explicitWaitTitleContains(By element, int time, String title) throws Exception{
		WebDriverWait titleContains = new WebDriverWait(getWebDriver(), time);
		titleContains.until(ExpectedConditions.titleContains(title));
	}
	...
	/** To Wait Until Element to be Visible */
	public static void explicitWaitVisibilityOfElement(By element, int time) throws Exception{
		WebDriverWait elementToBeVisible = new WebDriverWait(getWebDriver(), time);
	...
	/** To Wait Until Element is Selected */
	public static void explicitWaitSelectionStateToBe(By element, int time, boolean selected) throws Exception{
		WebDriverWait elementToBeVisible = new WebDriverWait(getWebDriver(), time);
	...
	public static void explicitWaitForAlert(int time) throws Exception{
