...
public class TestListener extends UISuiteHooks implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        LaunchBrowser browserPage = this.getMyBrowserPage();
        WebDriver webDriver = browserPage.getDriver();
